...
---------------------------------------------------
CREATE PROC USP_GETLISTBOOKBYIDBOOK
@IDBOOK int
AS 
BEGIN
...
-----------------------------------------------------
CREATE PROC USP_GETLISTBOOKBYNAMEBOOK
...
-----------------------------------------------------
CREATE PROC USP_GETLISTBOOKBYNAMECATEGORY
...
---------------------------------------------------
CREATE PROC USP_GETLISTBOOKBYNAMEAUTHOR
...
---------------------------------------------------
CREATE PROC USP_INSERTDETAILBILLBORROW
...
CREATE PROC USP_GETLISTIDREADERFROMBILLBORROW
AS
BEGIN
	SELECT MADOCGIA,CAST(MADOCGIA AS NVARCHAR(100)) + ' ' +  HOTEN AS HOTEN, DIACHI, EMAIL, MACONGVIEC,NGAYSINH, GIOITINH, SODIENTHOAI, NGAYTAOTHE, SONO FROM DOCGIA
	WHERE MADOCGIA IN ( 
...
---------------------------------------------------
CREATE PROC USP_INSERTDETAILBILLRETURN
...
CREATE PROC GETLISTBOOKFORDETAILBILLRETURN
@IDBILLBORROW INT
AS
BEGIN
...
CREATE PROC DELETE_DETAILBILLRETURN 
...
CREATE PROC REPORTBOOKUNRETURN
...
BEGIN
	...
	select  TENTHELOAI, count(*) as dem, count(*)/@tong*100 as tyle
