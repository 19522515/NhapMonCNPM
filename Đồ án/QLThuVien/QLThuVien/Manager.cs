    ...
    public partial class Manager : Form
    {
       ...
       void InsertPayment()
        ...
        void Load_dgv_Payment()
        {
            ...
            dgv_payment.Columns[0].HeaderText = "Mã phiếu thanh toán";
            dgv_payment.Columns[1].HeaderText = "Mã nhân viên";
            dgv_payment.Columns[2].HeaderText = "Mã độc giả";
            dgv_payment.Columns[3].HeaderText = "Số tiền thanh toán";
            dgv_payment.Columns[4].HeaderText = "Ngày thanh toán";
            dgv_payment.Columns[5].HeaderText = "Ghi chú thanh toán";
